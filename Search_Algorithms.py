...
def astar_search(graph, start, goal):
    ...
    path.append(start)
    path_cost = geographical_heuristic(start, goal)
    ...
    while len(frontier) > 0:
        ...
        path_cost_till_now, path_till_now = pop_frontier(frontier)
        current_node = path_till_now[-1]
        path_cost_till_now = path_cost_till_now - geographical_heuristic(current_node, goal)
        explored_nodes.append(current_node)
        # test goal condition
        if current_node == goal:
            return path_till_now, explored_nodes
        ...
        for neighbour in neighbours_list_str:
            ...
            extra_cost = 1
            neighbour_cost = extra_cost + path_cost_till_now + geographical_heuristic(neighbour, goal)
            new_element = (neighbour_cost, path_to_neighbour)
...
def greedy_search(graph, start, goal):
    ...
    while len(frontier) > 0:
        ...
        path_cost_till_now, path_till_now = pop_frontier(frontier)
        current_node = path_till_now[-1]
        path_cost_till_now = geographical_heuristic(current_node, goal)
        explored_nodes.append(current_node)
        # test goal condition
        if current_node == goal:
            return path_till_now, explored_nodes
...
def geographical_heuristic(node,goal):
...
if __name__ == '__main__':
    ...
    print("============ UCS Search ================")
    path_ucs, explored_ucs = uniform_cost_search(graph_neighbours, '0', '49')
    ...
    print("============ AStar Search ================")
    path_astar, explored_astar = astar_search(graph_neighbours, '0', '49')
    ...
    path_1, explored_1 = astar_search(graph_neighbours, '0', '49')
    path_2, explored_2 = astar_search(graph_neighbours, '0', '49')
    print("Path1:", path_1)
    print("Path_2:", path_2)
